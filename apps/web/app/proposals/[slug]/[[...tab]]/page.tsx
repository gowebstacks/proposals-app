...
export async function generateMetadata({ params }: ProposalPageProps): Promise<Metadata> {
  ...
  const url = `${SITE_URL}/proposals/${proposalSlug}`
...
export default async function ProposalPage({ params }: ProposalPageProps) {
  const { slug: proposalSlug, tab } = await params
  
  // Extract tab slug from URL
  // URL format: /proposals/proposal-slug/tab-slug or just /proposals/proposal-slug
